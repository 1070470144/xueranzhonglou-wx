...
.mode-card { display: flex; flex-direction: column; gap: 8rpx; padding: 28rpx 0; border-bottom: 1rpx solid #edf0f2; background: #ffffff; }
.mode-card text:first-child { font-size: 32rpx; font-weight: 700; }
.mode-card text:last-child { font-size: 24rpx; color: #8f959e; }
...
.small-btn { height: 64rpx; line-height: 64rpx; padding: 0 24rpx; border-radius: 10rpx; background: #ffffff; color: #1f2329; border: 1rpx solid #dfe2e6; font-size: 26rpx; }
.progress { margin-bottom: 14rpx; color: #8f959e; font-size: 26rpx; }
.question-card { padding-top: 10rpx; background: #ffffff; }
...
.result.ok { background: #f0f9f4; color: #1f8f4d; }
.result-line { margin-top: 10rpx; font-size: 26rpx; }
.result-explain { margin-top: 10rpx; color: #646a73; font-size: 26rpx; line-height: 1.5; text-align: left; }
.actions { display: flex; gap: 12rpx; margin-top: 24rpx; }
.ghost-btn, .primary-btn { flex: 1; height: 78rpx; line-height: 78rpx; border-radius: 10rpx; font-size: 28rpx; }
.ghost-btn { background: #ffffff; color: #1f2329; border: 1rpx solid #dfe2e6; }
.primary-btn { background: #20b15a; color: #ffffff; }
